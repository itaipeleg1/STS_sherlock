...
models_config_dict = {
    ...
    'C4_social':["llava_social_C41TR"],'C4_social_speak':["llava_social_speak_C41TR"],'C4_social_2TR':["llava_social_C42TR"],'C4_social_speak_2TR':["llava_social_speak_C42TR"],'social_clip_clap': ['social_nonsocial_truncated',"speaking_truncated","valence_truncated","arousal_truncated","mentalization_new",'clip_full','clap_full'],
    ...
    'llava_5TR_video' :["llava_7.5s_video"],'llava_6TR_video' :["llava_9.0s_video"],'llava_7TR_video' :["llava_10.5s_video"],"voice_emotion_dnn":["valence_scores","arousal_scores","dominance_scores"],
    ...
    'social_nonsocial_clip_full':['social_nonsocial_truncated', 'clip_full'],
    'speaking_clip_full':['speaking_truncated', 'clip_full'],
    'valence_clip_full':['valence_truncated', 'clip_full'],
    'arousal_clip_full':['arousal_truncated', 'clip_full'],
    'mentalization_clip_full':['mentalization_new', 'clip_full'],
    'social_nonsocial_clap_full':['social_nonsocial_truncated', 'clap_full'],
    'speaking_clap_full':['speaking_truncated', 'clap_full'],
    'valence_clap_full':['valence_truncated', 'clap_full'],
    'arousal_clap_full':['arousal_truncated', 'clap_full'],
    'mentalization_clap_full':['mentalization_new', 'clap_full'],
    'social_nonsocial':['social_nonsocial_truncated'],
    'valence':['valence_truncated'],
    'arousal':['arousal_truncated'],
    'mentalization':['mentalization_new'],
    'speaking':['speaking_truncated'],
}
