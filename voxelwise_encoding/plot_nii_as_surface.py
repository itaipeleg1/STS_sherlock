...
def plot_voxelwise_encoding_results_on_surface(results_file_path: str, model:str, feature:str):
    ...
    plotting.view_img_on_surf(img, surf_mesh='fsaverage', title=f'{model} - {feature}, max r: {np.max(data)}',
                              symmetric_cmap=False, cmap=plotting.cm.black_red, vmax=np.max(data)).save_as_html("/home/new_storage/sherlock/STS_sherlock/projects data/results/C4_check/map2.html")


path = r"/home/new_storage/sherlock/STS_sherlock/projects data/results/C4_check/group/c4/trial_1/c4_r.nii"
